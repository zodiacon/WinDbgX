...
namespace DebuggerEngine.Interop
{
    ...
    public struct CV_INFO_PDB20
    {
        ...
        public UInt32 Signature; // seconds since 01.01.1970
        public UInt32 Age; // an always-incrementing value 
    ...
    {
        [FieldOffset(0)]
        private readonly UInt32 Token;

        [FieldOffset(0)]
        private readonly UInt32 RVA;
    }
...
//} WDBGEXTS_CLR_DATA_INTERFACE, *PWDBGEXTS_CLR_DATA_INTERFACE;
            ...
            //    var Ioctl = (DebugUtilities.IoctlDelegate)Marshal.GetDelegateForFunctionPointer(
            //    windbgApis64.lpIoctlRoutine,
            //    typeof(DebugUtilities.IoctlDelegate));

            //Guid iid = new Guid("5c552ab6-fc09-4cb3-8e36-22fa03c798b7");
            //WDBGEXTS_CLR_DATA_INTERFACE query = new WDBGEXTS_CLR_DATA_INTERFACE(&iid);

            //if(Ioctl(IG.GET_CLR_DATA_INTERFACE, (IntPtr)(&query), (UInt32)Marshal.SizeOf(typeof(WDBGEXTS_CLR_DATA_INTERFACE))) == 0)
            //{
            //    debugUtilities.OutputErrorLine("ERROR! Unable to get the CLR data interface.");
            //    return MexMain.E_FAIL;
            //}

            //__iClrDataProcess = (IXCLRDataProcess)query.Interface;
...
//} WDBGEXTS_QUERY_INTERFACE, *PWDBGEXTS_QUERY_INTERFACE; 
    ...
    {
        private readonly UInt64 ModuleBase;
        private readonly UInt64 Offset;
        private readonly UInt64 FileNameId;
        private readonly UInt64 EngineInternal;
        private readonly UInt32 Size;
        private readonly UInt32 Flags;
        private readonly UInt32 FileNameSize;
        // Line numbers are one-based.
        // May be DEBUG_ANY_ID if unknown.
        private readonly UInt32 StartLine;
        private readonly UInt32 EndLine;
        // Column numbers are one-based byte indices.
        // May be DEBUG_ANY_ID if unknown.
        private readonly UInt32 StartColumn;
        private readonly UInt32 EndColumn;
    ...
    public struct FPO_DATA
    {
        ...
        public ushort cbProlog
        {
            get
            {
                return (ushort)((bitfield & 0xFF00) >> 8);
            }
        }
