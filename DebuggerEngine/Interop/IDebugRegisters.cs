...
namespace DebuggerEngine.Interop
{
	...
	public unsafe interface IDebugRegisters
	{
		[PreserveSig] int GetNumberRegisters(
		...
		[PreserveSig] int GetIndexByName(
